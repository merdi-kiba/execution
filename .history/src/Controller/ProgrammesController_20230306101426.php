...
class ProgrammesController extends AbstractController
{
    ...
    #[Route('/ressources/{id<\d+>}/detail', name: 'app_programmes_detail', methods: ['GET'])]
    ...
    #[Route('/ressources/new', name: 'app_programmes_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/ressources/{id<\d+>}/edit', name: 'app_ressources_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/ressources/{id<\d+>}/remove', name: 'app_ressources_remove', methods: ['GET'])]
