...
class EntrepriseExecuController extends AbstractController
{
    ...
    #[Route('/entreprise/execu/{id<\d+>}', name: 'voir_entite', methods:['GET'])]
    ...
    #[Route('/entreprise/execu/new', name: 'app_new_entite', methods: ['GET', 'POST'])]
    ...
    #[Route('/entreprise/execuedit/{id<\d+>}/edit', name: 'app_edit_entite', methods: ['GET', 'POST'])]
    ...
    #[Route('/entreprise/execuedit/{id<\d+>}/delet', name: 'app_delete_entreprise', methods: ['GET', 'POST'])]
